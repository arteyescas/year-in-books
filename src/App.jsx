...
const INITIAL_BOOKS = [
  ...
  { id: 9, title: 'PERSEPOLIS', author: 'SATRAPI', color: 'bg-[#1e1f26]', text: 'bg-[#f8b15d]', rating: 3, height: 180, width: 36, starsColor: 'text-pink-600', coverUrl: './covers/PERSEPOLIS.jpeg' }
];
