...
const INITIAL_BOOKS = [
  ...
  { id: 9, title: 'PERSEPOLIS', author: 'SATRAPI', color: 'bg-[#1e1f26]', text: 'text-teal-400', rating: 4, height: 180, width: 36, starsColor: 'text-pink-600', coverUrl: './covers/PERSEPOLIS.jpeg' }
];
